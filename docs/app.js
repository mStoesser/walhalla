...
var TickRoutes = /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(TickRoutes, [{
    ...
    value: function render() {
      ...
      }, this.selectedRoute ? x(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n                <div class=\"route\">\n                    <span>", "</span>\n                    <span>", "</span>\n                    <span>", "</span>\n                    <span>", "m</span>\n                </div>\n                <button @click=\"", "\">TICK</button>\n                <button @click=\"", "\">CANCEL</button>\n            "])), this.selectedRoute.line, this.selectedRoute.name, this.selectedRoute.grade, this.selectedRoute.height, function (_) {
