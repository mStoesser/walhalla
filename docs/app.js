...
var HomeStart = /*#__PURE__*/function (_HTMLElement) {
  function HomeStart() {
    ...
    _defineProperty(_this, "totalTime", 8 * 60 * 60);
    _defineProperty(_this, "totalMeter", 1300);
    _defineProperty(_this, "aimedSpeed", _this.totalMeter / (_this.totalTime / 60));
    _defineProperty(_this, "started", null);
...
var TickRoutes = /*#__PURE__*/function (_HTMLElement) {
  function TickRoutes() {
    ...
    _defineProperty(_this, "routes", []);
    _defineProperty(_this, "foundRoutes", []);
    _defineProperty(_this, "tickedRoutes", new Set());
    _defineProperty(_this, "selectedRoute", null);
    _defineProperty(_this, "routeApi", 'https://p01--heavens-gate-routes-api--dn2jq92t54q6.code.run/routes');
    _defineProperty(_this, "apiToken", 'NdM~sPuEc2rAc5Rnz9LDF3EHT');
    return _this;
  }
  _inherits(TickRoutes, _HTMLElement);
  return _createClass(TickRoutes, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      this.load();
      this.render();
    ...
    value: function render() {
      var _this3 = this;
      j(x(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n            <div>\n                <label>LineNr</label>\n                <input class=\"search\" name=\"search\" @keyup=\"", "\" type=\"number\" placeholder=\"search\">\n                <button @click=\"", "\">RELOAD ROUTES</button>\n            </div>\n            ", "\n        "])), function (e) {
        return _this3.search(e.target.value);
      }, function (_) {
        return _this3.loadRoutesAndRender();
      }, this.selectedRoute ? x(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n                <div class=\"route\">\n                    <span>", "</span>\n                    <span>", "</span>\n                    <span>", "</span>\n                    <span>", "m</span>\n                    <span class=\"route-color\" style=\"background: ", "\"></span>\n                </div>\n                <button @click=\"", "\">TICK</button>\n                <button @click=\"", "\">CANCEL</button>\n            "])), this.selectedRoute.line, this.selectedRoute.name, this.selectedRoute.grade, this.selectedRoute.height, this.selectedRoute.hexColor, function (_) {
        ...
        }, route.line.substring(0, 3), route.name, route.grade, route.height, route.hexColor);
      })) : '')), this);
    }
  }, {
    key: "loadRoutesAndRender",
    value: function () {
      var _loadRoutesAndRender = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var response;
      ...
      function loadRoutesAndRender() {
        return _loadRoutesAndRender.apply(this, arguments);
      }
      return loadRoutesAndRender;
    }()
  }, {
    key: "clear",
